...
var PartnerSpecificValidator = require('rubicon-project-htb-validator.js');
 ...
 * @class
 */
function RubiconProjectHtb(configs) {
    /* =====================================
     * Data
     * ---------------------------------- */
    ...
    */
    ...
    (function __constructor() {
        ...
        __profile = {
            partnerId: 'RubiconProjectHtb', // PartnerName
            namespace: 'RubiconProjectHtb', // Should be same as partnerName
            statsId: 'RUBI', // Unique partner identifier
            version: '2.1.0',
            targetingType: 'slot',
            enabledAnalytics: {
                requestTime: true
...
module.exports = RubiconProjectHtb;